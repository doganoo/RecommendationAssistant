...
use OCA\RecommendationAssistant\Service\RecommenderService;
...
class RecommenderJob extends TimedJob {
	...
	/**
	 * @var RecommenderService $recommenderService
	 */
	private $recommenderService = null;
